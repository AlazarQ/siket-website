                    ...
                    <div class="card blog blog-primary shadow rounded overflow-hidden border-0">
                        <div class="card-img image position-relative overflow-hidden">
                            <div class="p-4 pb-0">
                                ...
                                <h4 class="mb-3"><span class="post-title text-dark">{{$news->title}}</span></h4>
                            </div>
                            <div class="position-relative overflow-hidden mx-4 mt-4 rounded">
                                <img src="{{asset($news->file)}}" class="img-fluid news-detail-image" alt="">
                                <div class="bg">
                        ...
                        <div class="card-body content p-0">
                            <d class="p-4">
                              <p class="text-muted p-4">{!!$news->description!!}
                            </d></p>
                        </div>
                    </div>
                        ...
                        <div class="widget mb-4">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="clearfix post-recent">
                                    ...
                                    <div class="post-recent-content float-start"><a href="{{route('news-detail',['title'=>Str::slug($related->title)])}}">{{$related->title}}</a><span class="text-muted mt-2">April 23, 2024 </span></div>
                                </div>
                                @endforeach
                            </div>
                        </div>
